...
public class Response<V> {
    ...
    public static <T> Response<T> badRequest(String mensagem) {
        return new ResponseMessage<>(ResponseStatus.BAD_REQUEST, mensagem);
    }
    ...
    private static class ResponseMessage<V> extends Response<V> {
        ...
        private ResponseMessage(ResponseStatus status, String... mensagens) {
            this.mensagens = mensagens;
        }
