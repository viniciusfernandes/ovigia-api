...
public class DataUtil {
    ...
    public static int calcularDiferencaDias(Date date1, Date date2) {
        var zoneId = ZoneId.systemDefault(); // You may choose a different time zone
        var localDate1 = date1.toInstant().atZone(zoneId).toLocalDate();
        var localDate2 = date2.toInstant().atZone(zoneId).toLocalDate();
        var days = Period.between(localDate1, localDate2).getDays();
