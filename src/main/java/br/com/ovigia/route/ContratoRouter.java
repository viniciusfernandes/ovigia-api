...
public class ContratoRouter extends Router {
	...
	public ContratoRouter(ClienteRepository clienteRepository, ContratoRepository contratoRepository,
		...
		var criarContrato = Route.<CriarContratoRequest, Void>post().url("/ovigia/contratos").contemBody()
				...
				.rule(new CriarContratoRule(clienteRepository, contratoRepository, solicitacaoVisitaRepository));
